...
class _SchoolInfoState extends State<SchoolInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    final schoolViewModelObj= Provider.of<SchoolViewModel>(context).schoolData;
    String? schoolName = SchoolInfo.isPressed==true? schoolViewModelObj[0].schoolName : "School Name";
    String? schoolAddress = SchoolInfo.isPressed==true ? schoolViewModelObj[0].schoolAddress : "School Address";
    String? studentsNo = SchoolInfo.isPressed==true ? schoolViewModelObj[0].numberOfStudents : "Number of Students";
    String? teachersNo = SchoolInfo.isPressed==true ? schoolViewModelObj[0].numberOfTeachers : "Number of Teachers";
